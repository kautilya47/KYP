            ...
            <table className="min-w-full px-50 text-center text-sm font-light">
              <thead className="border-b bg-neutral-800 font-medium text-white dark:border-neutral-500 dark:bg-neutral-900">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-4">SIM link</th>
                  <th scope="col" className="px-6 py-4">Process</th>
                  <th scope="col" className="px-6 py-4">ASIN</th>
                  <th scope="col" className="px-6 py-4">MP or PRC</th>
                  <th scope="col" className="px-6 py-4">Error type</th>
                  <th scope="col" className="px-6 py-4">Error description</th>
                  <th scope="col" className="px-6 py-4">Correct resolution</th>
                </tr>
              </thead>
              <tbody>
                {data.length > 0 ? (
                  data.map((row, index) => (
                    <tr className="border-b dark:border-neutral-500" key={index}>
                      ...
                      <td className="py-4 font-medium">
                        <a href={`${row.sim_id}`} target="_blank" rel="noopener noreferrer">Sim link</a>
                      </td>
                  ...
                  <tr>
                    <td colSpan="8" className="py-4 font-medium text-center">
                      No data available
                    </td>
                  </tr>
                )}
